...
public class MockObjects {
    ...
    StockDto testFirstIBMStockDto =new StockDto("2022-09-06","IBM",
            ...
            BigDecimal.valueOf(126.72), BigDecimal.valueOf(11),BigDecimal.valueOf(3345343.00));
    StockDto testSecondIBMStockDto =new StockDto("2022-08-31","IBM",
            ...
            BigDecimal.valueOf(128.45), BigDecimal.valueOf(22),BigDecimal.valueOf(3490380.00));
    StockDto testThirdAAPLStockDto =new StockDto("2022-09-06","AAPL",
            ...
            BigDecimal.valueOf(128.45), BigDecimal.valueOf(33),BigDecimal.valueOf(73295539.00));
